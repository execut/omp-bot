...
import (
    "github.com/ozonmp/omp-bot/internal/app/commands/ozon"
    "log"
    "runtime/debug"
...
func NewRouter(
    ...
    return &Router{
        ...
        bot: bot,
        // ozonCommander
        ozonCommander: ozon.NewOzonCommander(bot),
        // user
        // access
        // buy
        // delivery
...
func (c *Router) handleCallback(callback *tgbotapi.CallbackQuery) {
    ...
    case "ozon":
        c.ozonCommander.HandleCallback(callback, callbackPath)
    case "user":
        break
    case "access":
        break
...
func (c *Router) handleMessage(msg *tgbotapi.Message) {
    ...
    case "ozon":
        c.ozonCommander.HandleCommand(msg, commandPath)
    case "user":
        break
    case "access":
        break
